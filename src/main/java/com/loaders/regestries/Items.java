...
import com.loaders.items.MistAmulet;
import com.loaders.items.ScorchingWave;
import com.loaders.items.SinnerStaff;
import com.loaders.items.WitheringSword;
...
public class Items {
    ...
    private static final ArmorMaterial SpiritiumArmorMaterial = new SpiritiumArmorMaterial();
    ...
    public static final Item SOUL_MORPHIST = register("soul_morphist", new SwordItem(SpiritiumMaterial, 5, -1.2f, new FabricItemSettings()));
    public static final Item WITHERING_SWORD = register("withering_sword", new WitheringSword(SpiritiumMaterial, 3, -2.4f, new FabricItemSettings()));
    ...
    public static final Item SPIRITIUM_AXE = register("spiritium_axe", new AxeItem(SpiritiumMaterial, 6, -3.1f, new FabricItemSettings()));
    public static final Item SPIRITIUM_PICKAXE = register("spiritium_pickaxe", new PickaxeItem(SpiritiumMaterial, -2, -2.8f, new FabricItemSettings()));
    public static final Item SPIRITIUM_SHOVEL = register("spiritium_shovel", new ShovelItem(SpiritiumMaterial, -1, -3.0f, new FabricItemSettings()));
    ...
    public static final Item SPIRITIUM_MULTITOOL = register("spiritium_multitool", new PickaxeItem(SpiritiumMaterial, 4, -2.4f, new FabricItemSettings()));
